...
const showRecipe = async function() {
    try {
        ...
        (0, _recipeViewJsDefault.default).renderError(`${err}\u{1F926}\u{200D}\u{2640}\u{FE0F}\u{1F926}\u{200D}\u{2640}\u{FE0F}\u{1F926}\u{200D}\u{2640}\u{FE0F} `);
    }
};
...
const controlServings = function(newServings) {
    _modelJs.updateSevings(newServings);
...
const init = function() {
    ...
    (0, _paginationJsDefault.default).addHandlerClick(controlPagination);
    (0, _addRecipeViewJsDefault.default)._addHandlerUpload(controlAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./views/recipeView.js":"3wx5k","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/searchView.js":"kbE4Z","./views/resultsView.js":"kBQ4r","./views/pagination.js":"j9M5d","./views/bookmarksView.js":"1qGeA","./views/addRecipeView.js":"8AWnP","./config.js":"2hPh4"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
parcelHelpers.export(exports, "updateSevings", ()=>updateSevings);
...
const loadRecipe = async function(id) {
    try {
        ...
        console.error(`${err}\u{1F937}\u{200D}\u{2642}\u{FE0F}\u{1F937}\u{200D}\u{2642}\u{FE0F}`);
        throw err;
    }
};
...
const updateSevings = function(newServings) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./config.js":"2hPh4","./helper.js":"b1fwP","./views/recipeView.js":"3wx5k"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
//Constat Values that can be changed
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_URL", ()=>API_URL);
parcelHelpers.export(exports, "RES_PER_PAGE", ()=>RES_PER_PAGE);
parcelHelpers.export(exports, "Key", ()=>Key);
parcelHelpers.export(exports, "Form_Close", ()=>Form_Close);
const API_URL = 'https://forkify-api.jonas.io/api/v2/recipes/';
const RES_PER_PAGE = 10;
const Key = '9b05b197-069d-4d71-8e4b-0ee0ea1ca4e3';
const Form_Close = 2;
...
class recipeView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = `Unfortunately not able to find this recipe . Please try another one`;
...
},{"./View.js":"jSw21","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"j9M5d":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class Pagination extends (0, _viewJsDefault.default) {
